  ...
  return (
    <div className="container m-auto p-3 mt-4 " style={{width:"80%", lineHeight:"25px"}} >
      ...
      <section className="course-info mt-4">
        ...
        <p>
          🔹 The entire course is priced at <strong>1000 EGP</strong>, which is a reasonable price to start your journey in <strong>Front-end development</strong> and programming.
        </p>
        <p>
